'''This module demonstrates least common multiple
...
def main():
    '''Tests'''
    description = __doc__ if __doc__ else "LCM and GCD calculations"

    print(
        fTable(
            description + ' of 60 and [12..20]:'
        )(repr)(repr)(
            lcm(60)
        )(enumFromTo(12)(20))
    )
